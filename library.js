...
console.log("\nPrinting playlist with ID p01:");
printPlaylist("p01");

console.log("\nAdding track t03 to playlist p01:");
addTrackToPlaylist("t03", "p01");
console.log("Updated playlist p01:");
printPlaylist("p01");

console.log("\nAdding a new track:");
addTrack("New Track", "New Artist", "New Album");
console.log("All tracks after adding new track:");
printTracks();

console.log("\nAdding a new playlist:");
addPlaylist("New Playlist");
console.log("All playlists after adding new playlist:");
printPlaylists();

console.log("\nSearching for tracks containing 'Code':");
